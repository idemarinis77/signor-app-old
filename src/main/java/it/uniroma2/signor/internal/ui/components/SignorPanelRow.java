...
public class SignorPanelRow extends JPanel{
    ...
    public void signorPanelRowDetailNode(JPanel jp, EasyGBC gbc, CyRow rownode){
        ...
        try{
            ...
            String link_to_db = CONFIG.DBLINKSMAP.get(db_value_norm).queryFunction.apply("p62258");
            BufferedImage dblogo = ImageIO.read(getClass().getResource("/images/signor_logo_small.png"));
